...
void scramble(queue<T>& q)
{
    ...
    bool reverse = false;//do not want to reverse the elements initially
    while(elementsLeft > 0){
      ...
      elementsLeft-=blockSize;
      blockSize + 1 > elementsLeft ? blockSize = elementsLeft : blockSize+=1;//conditionally set blockSize
      reverse = !reverse;
    }
}//end of function
